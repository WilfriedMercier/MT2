!Mercier Wilfried
!09/01/2019
!Equation de burger - V7
!Boucle spatiale parallelisee + ecriture correcte avec MASTER
...
PROGRAM Burger
   ...
   !...Declaration...
      ...
      INTEGER,      PARAMETER           :: NTOT = 200             !Nombre de pas selon x
      INTEGER,      PARAMETER           :: NSPACEX = NTOT/4       !Nombre de pas selon x
      !...Tableaux...
